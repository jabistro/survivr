                        ...
                        <div key={album.id} className='others-album-wrap'>
                            <Link className='others-album-pics-link' to={`/users/${user.id}/albums/${album.id}/images`}>
                                <div className='others-album-pics'>
                                    <img className='others-album-pics-one' alt='' title={images.filter(image => image.albumId === album.id)[0] ? images.filter(image => image.albumId === album.id)[0].title : null} src={!(images.filter(image => image.albumId === album.id)[0]) ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7-PDfavcidh7T4Ocucr_DtQ-Xe_0MA3JQ5h5j93zs2j_S_IT65S1C58fbJsieXcKSGDE&usqp=CAU" : images.filter(image => image.albumId === album.id)[0].imageURL} />
                                    <div className='others-album-pics-right'>
                                        <img className='others-album-pics-two' alt='' title={images.filter(image => image.albumId === album.id)[1] ? images.filter(image => image.albumId === album.id)[1].title : null} src={!(images.filter(image => image.albumId === album.id)[1]) ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7-PDfavcidh7T4Ocucr_DtQ-Xe_0MA3JQ5h5j93zs2j_S_IT65S1C58fbJsieXcKSGDE&usqp=CAU" : images.filter(image => image.albumId === album.id)[1].imageURL} />
                                        <img className='others-album-pics-three' alt='' title={images.filter(image => image.albumId === album.id)[2] ? images.filter(image => image.albumId === album.id)[2].title : null} src={!(images.filter(image => image.albumId === album.id)[2]) ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7-PDfavcidh7T4Ocucr_DtQ-Xe_0MA3JQ5h5j93zs2j_S_IT65S1C58fbJsieXcKSGDE&usqp=CAU" : images.filter(image => image.albumId === album.id)[2].imageURL} />
                                    </div>
                                </div>
                            </Link>
